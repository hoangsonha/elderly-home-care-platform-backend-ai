...
public class AccountController {
    ...
    public ResponseEntity<ObjectResponse> accountRegister(
        ...
        try {
            ...
            return account
                    ? ResponseEntity.status(HttpStatus.OK)
                            .body(new ObjectResponse("Success", "Account registration successful", account))
                    : ResponseEntity.status(HttpStatus.BAD_REQUEST).body(
                            new ObjectResponse("Fail", "Account registration failed due to email sending error", null));
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                    .body(new ObjectResponse("Fail", "Account registration failed", null));
        }
    }

    @PostMapping("/register/verification")
    public ResponseEntity<TokenResponse> userRegister(
            @Valid @RequestBody AccountVerificationRequest accountRegisterRequest) {
        try {
            TokenResponse tokenResponse = accountService.verificationUser(accountRegisterRequest);
            return ResponseEntity
                    .status(tokenResponse.getCode().equals("Success") ? HttpStatus.OK : HttpStatus.UNAUTHORIZED)
                    .body(tokenResponse);
        } catch (BadRequestException e) {
            log.error("Error verification found : {}", e.toString());
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new TokenResponse("Failed", e.getMessage(), null,
    ...
    public ResponseEntity<ObjectResponse> resendCodeVerify(@Valid @RequestBody ResendCodeVerifyRequest request) {
        try {
            ...
            return success
                    ? ResponseEntity.status(HttpStatus.OK)
                            .body(new ObjectResponse("Success", "Verification code resent successfully", null))
                    : ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ObjectResponse("Fail",
                            "Failed to resend verification code due to email sending error", null));
        } catch (BadRequestException e) {
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                    .body(new ObjectResponse("Fail", "Failed to resend verification code", null));
        }
    }
    ...
    public ResponseEntity<TokenResponse> loginPage(@Valid @RequestBody AccountLoginRequest accountLoginRequest) {
        try {
            TokenResponse tokenResponse = accountService.login(accountLoginRequest.getEmail(),
    ...
    public ResponseEntity<ObjectResponse> getLogout(HttpServletRequest request) {
        try {
            ...
            return checkLogout
                    ? ResponseEntity.status(HttpStatus.OK)
                            .body(new ObjectResponse("Success", "Logout successful", null))
    ...
    // */
    // @Operation(summary = "Get all air-crafts", description = "Retrieves all
    // air-crafts, with optional pagination")
    //// @PreAuthorize("hasRole('ADMIN') or hasRole('USER') or hasRole('STAFF')")
    // @GetMapping("")
    // public ResponseEntity<PagingResponse> getAllAircraft(@RequestParam(value =
    // "currentPage", required = false) Integer currentPage,
    ...
    // aircraftService.getAircraftsPaging(resolvedCurrentPage, resolvedPageSize);
    ...
    // * @return list or empty
    // */
    // @Operation(summary = "Get all air-crafts non paging", description =
    // "Retrieves all air-crafts, without optional pagination")
    ...
    // return !results.isEmpty() ? ResponseEntity.status(HttpStatus.OK).body(new
    // ObjectResponse("Success", "get all aircrafts non paging successfully",
    // results)) :
    // ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new
    // ObjectResponse("Failed", "get all aircrafts non paging failed", results));
    // }
    //
    // /**
    ...
    // * @return list or empty
    // */
    // @Operation(summary = "Search air-crafts", description = "Retrieves all
    // air-crafts are filtered by code, model and manufacturer")
    //// @PreAuthorize("hasRole('USER') or hasRole('ADMIN')")
    // @GetMapping("/search")
    // public ResponseEntity<PagingResponse> searchAircraft(@RequestParam(value =
    // "currentPage", required = false) Integer currentPage,
    // @RequestParam(value = "pageSize", required = false) Integer pageSize,
    ...
    // int resolvedPageSize = (pageSize != null) ? pageSize : defaultPageSize;
    //
    // PagingResponse results = aircraftService.searchAircrafts(resolvedCurrentPage,
    // resolvedPageSize, code, model, manufacturer);
    // List<?> data = (List<?>) results.getData();
    // return ResponseEntity.status(!data.isEmpty() ? HttpStatus.OK :
    // HttpStatus.BAD_REQUEST).body(results);
    // }
    ...
    // @GetMapping("/{id}")
    // public ResponseEntity<ObjectResponse> getAircraftByID(@PathVariable("id")
    // UUID id) {
    ...
    //// @PreAuthorize("hasRole('ADMIN')")
    // @PostMapping("")
    // public ResponseEntity<ObjectResponse> createAircraft(@Valid @RequestBody
    // CreateAircraftRequest createAircraftRequest) {
    // try {
    // AircraftResponseDTO aircraft =
    // aircraftService.createAircraft(createAircraftRequest);
    // return ResponseEntity.status(HttpStatus.OK).body(new
    // ObjectResponse("Success", "Create aircraft successfully", aircraft));
    // } catch (BadRequestException e) {
    // log.error("Error creating aircraft", e);
    // return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new
    // ObjectResponse("Fail", e.getMessage(), null));
    // } catch (ElementExistException e) {
    // log.error("Error creating aircraft", e);
    // return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new
    // ObjectResponse("Fail", e.getMessage(), null));
    ...
    // log.error("Error creating aircraft", e);
    // return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new
    // ObjectResponse("Fail", "Create aircraft failed", null));
    // }
    // }
    //
    // /**
    ...
    // @PutMapping("/{id}")
    // public ResponseEntity<ObjectResponse> updateAircraft(@PathVariable("id") UUID
    // id, @RequestBody UpdateAircraftRequest updateAircraftRequest) {
    // try {
    // AircraftResponseDTO aircraft =
    // aircraftService.updateAircraft(updateAircraftRequest, id);
    // if (aircraft != null) {
    // return ResponseEntity.status(HttpStatus.OK).body(new
    // ObjectResponse("Success", "Update aircrafts successfully", aircraft));
    // }
    // return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new
    // ObjectResponse("Fail", "Update aircrafts failed. aircrafts is null", null));
    // } catch (BadRequestException e) {
    // log.error("Error creating aircraft", e);
    // return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new
    // ObjectResponse("Fail", e.getMessage(), null));
    ...
    // log.error("Error while updating aircraft", e);
    // return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new
    // ObjectResponse("Fail", "Update Aircraft failed. Aircraft not found", null));
    // } catch (Exception e) {
    // log.error("Error updating aircrafts", e);
    // return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new
    // ObjectResponse("Fail", "Update aircrafts failed", null));
    // }
    // }
    //
    // /**
    ...
    // * @return aircraft or null
    // */
    // @Operation(summary = "Delete aircraft", description = "Delete aircraft by
    // aircraft id set delete = true")
    //// @PreAuthorize("hasRole('ADMIN')")
    // @DeleteMapping("/{id}")
    // public ResponseEntity<ObjectResponse> deleteAircraftByID(@PathVariable("id")
    // UUID id) {
    // try {
    // AircraftResponseDTO aircrafts = aircraftService.deleteAircraft(id);
    // if(aircrafts != null) {
    // return ResponseEntity.status(HttpStatus.OK).body(new
    // ObjectResponse("Success", "Delete aircrafts successfully", aircrafts));
    // }
    // return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new
    // ObjectResponse("Fail", "Delete aircrafts failed", null));
    // } catch (ElementNotFoundException e) {
    // log.error("Error while updating aircrafts", e);
    // return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new
    // ObjectResponse("Fail", "Update Aircraft failed" + e.getMessage(), null));
    // } catch (Exception e) {
    ...
    // * @return aircraft or null
    // */
    // @Operation(summary = "Restore aircraft", description = "Restore aircraft by
    // aircraft id set delete = false")
    //// @PreAuthorize("hasRole('MANAGER') or hasRole('ADMIN')")
    // @PutMapping("/{id}/restore")
    // public ResponseEntity<ObjectResponse>
    // unDeleteAircraftByID(@PathVariable("id") UUID id) {
    // try {
    // AircraftResponseDTO aircraft = aircraftService.unDeleteAircraft(id);
    // if(aircraft != null) {
    // return ResponseEntity.status(HttpStatus.OK).body(new
    // ObjectResponse("Success", "UnDelete aircraft successfully", aircraft));
    // }
    // return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new
    // ObjectResponse("Fail", "Aircraft is null", null));
    // } catch (ElementNotFoundException e) {
    // log.error("Error while updating aircraft", e);
    // return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new
    // ObjectResponse("Fail", "Update Aircraft failed" + e.getMessage(), null));
    // } catch (Exception e) {
    // return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new
    // ObjectResponse("Fail", "Undelete aircraft failed", null));
    // }
    // }
