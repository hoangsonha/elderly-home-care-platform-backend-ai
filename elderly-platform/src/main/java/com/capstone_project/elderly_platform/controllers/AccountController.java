                        ...
                        return account
                                        ? ResponseEntity.status(HttpStatus.OK)
                                                        .body(new ObjectResponse("Success",
                                                                        "Account registration successful", account))
                                        : ResponseEntity.status(HttpStatus.BAD_REQUEST).body(
                                                        new ObjectResponse("Fail",
                                                                        "Account registration failed due to email sending error",
                                                                        null));
        ...
        public ResponseEntity<TokenResponse> userRegister(
                ...
                try {
                        ...
                        return ResponseEntity
                                        .status(tokenResponse.getCode().equals("Success") ? HttpStatus.OK
                                                        : HttpStatus.UNAUTHORIZED)
                                        .body(tokenResponse);
                } catch (BadRequestException e) {
                        log.error("Error verification found : {}", e.toString());
                        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                                        .body(new TokenResponse("Failed", e.getMessage(), null,
        ...
        public ResponseEntity<ObjectResponse> resendCodeVerify(@Valid @RequestBody ResendCodeVerifyRequest request) {
                try {
                        ...
                        return success
                                        ? ResponseEntity.status(HttpStatus.OK)
                                                        .body(new ObjectResponse("Success",
                                                                        "Verification code resent successfully", null))
                                        : ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ObjectResponse("Fail",
                                                        "Failed to resend verification code due to email sending error",
                                                        null));
                } catch (BadRequestException e) {
